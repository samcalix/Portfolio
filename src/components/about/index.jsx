    ...
    <section className="py-20 w-full">
      <div className="grid grid-cols-12 gap-4 xs:gap-6  md:gap-8 w-full">
        ...
        >
          ...
          My journey in web development is fueled by a passion for building responsive, interactive experiences. With JavaScript as my foundation, I use tools like React.js and AWS to create dynamic websites that connect users effortlessly. My skills in HTML, CSS, and JavaScript help me blend functionality with design, ensuring every project is both intuitive and visually appealing. As I explore new technologies, I’m committed to continuously improving and pushing the boundaries of web development.
          </p>
        </ItemLayout>
        ...
        <ItemLayout className={"col-span-full"}>
          <img
            className="w-full h-auto"
            src={`https://skillicons.dev/icons?i=js,html,css,aws,react,bootstrap,py`}
            alt="CodeBucks"
            loading="lazy"
          />
        </ItemLayout>
